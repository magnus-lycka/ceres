...
class TestRobotManipulatorSlotEffect:
    ...
    def test_mixed_size_third_manipulator(self):
        # SIZE_5 robot: 2×SIZE_5(2 slots each) + 1×SIZE_3(delta=-2 → 1 slot)
...
class TestRobotTotalCost:
    ...
    def test_enhanced_manipulators_cost_effect(self):
        # SIZE_5 robot with 2×(str_bonus=3) + 1×SIZE_3(dex_bonus=4):
        # arm costs: 5000 + 5000 + 9900 = 19900; std = 2×500 = 1000; net = +18900
        robot = make_robot(
            size=RobotSize.SIZE_5,
            tl=14,
            manipulators=[
        ...
        assert robot._manipulator_cost_effect == pytest.approx(18900.0)
...
class TestManipulatorSpecDisplay:
    ...
    def test_enhanced_stats_shown_in_spec(self):
        # SIZE_5 TL14 with str_bonus=3: effective STR 12; SIZE_3 dex_bonus=4: effective DEX 12
        from ceres.make.robot.spec import RobotSpecSection
