"""Helpers for writing generated regression artifacts from vehicle gallery tests."""
...
def write_json_output(test_name: str, vehicle: Vehicle) -> Path:
    return write_json_model_output(JSON_OUTPUT_DIR, test_name, vehicle)
