...
def test_all_approval_robots_in_gallery():
    approval_dir = Path(__file__).parent.parent.parent / 'approval' / 'robot' / 'e2e'
    ...
    imported_modules = set(re.findall(r'from tests\.approval\.robot\.e2e\.(test_\w+) import', gallery_text))
