...
| Sophont                     | Category | Code | Location          | Source            | Characteristic changes                                                                      | Replacement char        | New char                | Special                                                                                                            |
| --------------------------- | -------- | ---- | ----------------- | ----------------- | ------------------------------------------------------------------------------------------- | ----------------------- | ----------------------- | ------------------------------------------------------------------------------------------------------------------ |
...
| Za'tachk                    | Alien    | Za't | Wren              | AoCS 4            | STR+1; Matriarchs INT+1 EDU+1 BOL-1; Scouts INT-1 EDU-1 BOL+1                               | —                       | BOL (1D+1)              | Three sexes; age 10/15 start; Coward trait                                                                         |
...
| Zhodani                     | Major    | Zhod | Zhodani space     | AoCS 1 / BTC      | EDU min 8 if SOC 10+                                                                        | —                       | PSI (rolled first)      | Social class tiers gate careers                                                                                    |
...
| Chir | Chirpers | major | Devolved/pre-sapient Droyne; not player-characters in standard rules |
| Clot | Clotho | Tien | |
| Darm | Darmine | Zaru | |
