...
| Kirissukyoya                | Alien    | —    | Re:(Kirissukyoya)       | BTC               | STR-1                                                                                       | All Core careers; Eidetic Sense (hearing); Claws 1D; Mechanic 1 innate                                          |
...
| Vargr (in Extents)          | Major    | Varg | A:Va*                   | AoCS 1            | STR-2, DEX+1, END-1; SOC → CHA (1D+2)                                                       | Vargr careers; CHA gain/loss mechanic; Bite (1D+1); Heightened Senses                                           |
