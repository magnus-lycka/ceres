...
class PrisonerEvent9Level1Handler(CareerHandlerBase):
    type: Literal['prisoner_event_9_level_1'] = 'prisoner_event_9_level_1'
...
class PrisonerEvent9Level2Handler(CareerHandlerBase):
    type: Literal['prisoner_event_9_level_2'] = 'prisoner_event_9_level_2'
...
class PrisonerEvent9Level3Handler(CareerHandlerBase):
    type: Literal['prisoner_event_9_level_3'] = 'prisoner_event_9_level_3'
